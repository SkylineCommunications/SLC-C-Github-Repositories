namespace Skyline.Protocol.PollManager.ResponseHandler
{
    ...
    public static class ResponseHandler
    {
        private static IReadOnlyDictionary<RequestType, Action<SLProtocol>> handlers = new Dictionary<RequestType, Action<SLProtocol>>
        {
            ...
            { RequestType.Repositories_Workflows,               WorkflowResponseHandler.HandleRepositoriesWorkflowsResponse },
            ...
            { RequestType.Workflow_Execution,                   WorkflowResponseHandler.HandleExecuteWorkflowResponse },
        };
