namespace Skyline.Protocol.Tables
{
    ...
    public class RepositoryIssuesTable
    {
        public RepositoryIssuesTable() { }

        public RepositoryIssuesTable(SLProtocol protocol)
        {
        ...
        public List<RepositoryIssuesRow> Rows { get; set; } = new List<RepositoryIssuesRow>();
