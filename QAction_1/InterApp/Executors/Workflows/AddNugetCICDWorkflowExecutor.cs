...
#pragma warning disable S101 // Types should be named in PascalCase
	public class AddNugetCICDWorkflowExecutor : MessageExecutor<GenericInterAppMessage<AddNugetCICDWorkflowRequest>>
#pragma warning restore S101 // Types should be named in PascalCase
	{
		...
		public AddNugetCICDWorkflowExecutor(GenericInterAppMessage<AddNugetCICDWorkflowRequest> message) : base(message)
		{
		...
		public override bool Validate()
		{
			...
			// Check Nuget API key
			if (String.IsNullOrWhiteSpace(Message.Data.Data.NugetApiKey))
			{
				result.Success = false;
		...
		public override void DataSets(object dataDestination)
		{
			...
			var workflow = WorkflowFactory.CreateNugetCICDWorkflow(Message.Data.Data.SonarCloudProjectID);
			...
			RepositoriesRequestHandler.CreateRepositorySecret(protocol, Message.Data.RepositoryId.FullName, "NUGETAPIKEY", Message.Data.Data.NugetApiKey);
