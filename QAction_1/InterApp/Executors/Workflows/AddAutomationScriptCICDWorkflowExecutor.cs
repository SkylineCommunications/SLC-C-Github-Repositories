...
#pragma warning disable S101 // Types should be named in PascalCase
	public class AddAutomationScriptCICDWorkflowExecutor : MessageExecutor<GenericInterAppMessage<AddAutomationScriptCICDWorkflowRequest>>
#pragma warning restore S101 // Types should be named in PascalCase
	{
		...
		public AddAutomationScriptCICDWorkflowExecutor(GenericInterAppMessage<AddAutomationScriptCICDWorkflowRequest> message) : base(message)
		{
		...
		public override void DataSets(object dataDestination)
		{
			...
			var workflow = WorkflowFactory.CreateAutomationCICDWorkflow(Message.Data.Data.SonarCloudProjectID);
			...
			new IAC_MessagesTableRow
			{
				...
				Request = Message,
				RequestType = typeof(AddAutomationScriptCICDWorkflowRequest),
